...
export function App() { return <Routes><Route element={<Shell/>}><Route index element={<Foundation title="制作のつづきへ"/>}/><Route path="songs" element={<Foundation title="曲"/>}/><Route path="inbox" element={<Foundation title="Inbox"/>}/><Route path="settings" element={<Foundation title="設定"/>}/><Route path="*" element={<div className="page"><h1>ページが見つかりません</h1><Link to="/">ホームへ戻る</Link></div>}/></Route></Routes> }
